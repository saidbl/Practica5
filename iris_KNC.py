...
print("=== KNeighborsClassifier (Iris) ===")
...
ax.set_title("Matriz de Confusión - KNeighborsClassifier")
...
ax.set_ylim(0, 1.05)
ax.set_ylabel("Score")
ax.set_title("Métricas por clase y macro (KNN)")
ax.legend()
plt.tight_layout()
plt.show()
...
correct = y_test == knn.predict(X_test)
...
ax.set_title("Process (PCA 2D) — Regiones de decisión (KNN)")
ax.set_xlabel("PC1")
ax.set_ylabel("PC2")
ax.legend(loc="best")
plt.tight_layout()
