...
plt.title("Matriz de Confusión - SVC sin escalado")
...
plt.title("Sepal Length vs Sepal Width - SVC sin escalado")
plt.legend()
plt.show()
...
plt.title("Petal Length vs Petal Width - SVC sin escalado")
plt.legend()
plt.show()
