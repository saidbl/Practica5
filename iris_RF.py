...
print("=== RandomForestClassifier (Iris) ===")
...
ax.set_ylim(0, 1.05)
ax.set_ylabel("Score")
ax.set_title("Métricas por clase y macro (Random Forest)")
ax.legend()
plt.tight_layout()
plt.show()
...
clf_viz = RandomForestClassifier(n_estimators=100, random_state=42)
...
ax.set_title("Process (PCA 2D) — Regiones de decisión (Random Forest)")
ax.set_xlabel("PC1")
ax.set_ylabel("PC2")
ax.legend(loc="best")
plt.tight_layout()
