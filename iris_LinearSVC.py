...
# 3) LinearSVC (modelo principal en 4D)
...
ax.set_title("Matriz de Confusión - LinearSVC")
...
ax.set_ylim(0, 1.05)
ax.set_ylabel("Score")
ax.set_title("Métricas por clase y macro (LinearSVC)")
ax.legend()
plt.tight_layout()
plt.show()
...
svc_viz = LinearSVC(max_iter=10000, dual=False, random_state=42)
...
ax.set_title("Process (PCA 2D) — Regiones de decisión (LinearSVC)")
ax.set_xlabel("PC1")
ax.set_ylabel("PC2")
ax.legend(loc="best")
plt.tight_layout()
